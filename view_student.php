        ...
        <br>
         <table border="1px">
            ...
            <tr>
                ...
                <td class="table_td"><?php echo "<a class='btn btn-danger' onClick=\" javascript:return confirm('Are you sure to delete this')\" href='delete.php?student_id={$info['id']}'>Delete</a>"; ?></td>
